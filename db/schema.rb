...
ActiveRecord::Schema[7.0].define(version: 2026_01_20_073142) do
  ...
  create_table "assets", primary_key: "asset_id", force: :cascade do |t|
    ...
    t.index ["requisition_id"], name: "index_assets_on_requisition_id"
  end
  ...
  add_foreign_key "assets", "requisitions", primary_key: "requisition_id"
